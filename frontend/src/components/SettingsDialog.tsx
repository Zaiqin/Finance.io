  ...
  return (
    <div className={`fixed inset-0 flex items-center justify-center ${nightMode ? "bg-gray-900" : "bg-black"} bg-opacity-50 z-20 p-6`}>
      ...
      >
        ...
        <input
        className={`shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline ${nightMode ? "bg-gray-700 text-white" : "bg-white text-gray-700"}`}
        id="newCategory"
        type="text"
        value={newCategory}
        placeholder="Name"
